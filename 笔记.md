...
In the object header, there are mark word, klass pointer. Besides, object header will also where length field resides if the object is an instance of array.
