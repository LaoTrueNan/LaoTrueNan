...
A Java class without an access modifier, it is called default access modifier. The scope of this modifier is limited to this package only.
...
processor are assigned to create a Request and Response object for every socket(request)
